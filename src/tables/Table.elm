module Table exposing
  ( view
  , config, stringColumn, intColumn, floatColumn, dataToStringColumn, dataToIntColumn
  , State, initialSort
  ...
  , darkGrey, lightGrey, simpleThead, simpleTheadHelp, simpleTheadContent, simpleRowAttrs
  )
...
{-|-}
dataToStringColumn : String -> (data -> HtmlDetails msg) -> (data -> String) -> Column data msg
dataToStringColumn name toHtml toStr =
  Column
  { name = name
  , viewData = toHtml
...
{-|-}
dataToIntColumn : String -> (data -> HtmlDetails msg) -> (data -> Int) -> Column data msg
dataToIntColumn name toHtml toInt =
  Column
  { name = name
  , viewData = toHtml
